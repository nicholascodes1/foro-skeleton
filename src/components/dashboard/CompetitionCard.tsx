      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="mt-1 flex shrink-0 gap-2.5 text-gray-400">
            ...
            <button aria-label="Save competition" className="transition-colors hover:text-blue-500">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 21L12 16L5 21V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H17C17.5304 3 18.0391 3.21071 18.4142 3.58579C18.7893 3.96086 19 4.46957 19 5V21Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <button aria-label="Share competition" className="transition-colors hover:text-gray-800">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex items-center gap-1.5">
          <Image src="/dashboard-assets/location-icon.svg" width={12} height={12} alt="location-icon" className="h-auto w-3" />
        ...
        <div className="mt-0 flex flex-col gap-1.5">
          ...
          <p className="font-space-grotesk text-[11px] leading-snug text-gray-600 sm:text-xs">
            <span className="font-bold text-gray-800">Format:</span> {data.groupSize}
          </p>
        </div>
