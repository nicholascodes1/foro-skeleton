...
export interface CompetitionCardData<T extends number> {
  title: string;
  image: string;
  tags: string[];
...
interface CompetitionCardProps<T extends number> {
  data: CompetitionCardData<T>;
  rotation?: number;
}

export default function CompetitionCard<T extends number>({ data, rotation = 0 }: CompetitionCardProps<T>) {
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-space-grotesk text-gray-400 font-semibold">
              25+
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          <Image
            src="/dashboard-assets/Vector.svg"
            width={100}
            height={100}
            alt="location-icon"
